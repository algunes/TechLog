		...
		if (sessionFactory == null) {
			...
			try {
				...
				MetadataSources sources = new MetadataSources(standardServiceRegistry)
						.addAnnotatedClass(com.TechLog.Test.Permissions.Users.class)
						.addAnnotatedClass(com.TechLog.Test.Permissions.DomainPermissions.class)
						.addAnnotatedClass(com.TechLog.Test.Permissions.Permission.class)
						.addAnnotatedClass(com.TechLog.Test.Permissions.CustomerDomainPermission.class)
						.addAnnotatedClass(com.TechLog.Test.Permissions.ProductDomainPermission.class)
						.addAnnotatedClass(com.TechLog.Test.Permissions.StockDomainPermission.class);
